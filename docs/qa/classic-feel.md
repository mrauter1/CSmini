...
- Movement cadence: `pass`
  Evidence: fresh same-window travel sample was `1.72` standing vs `0.79` crouched, with walk `8.6u/s` and crouch `4.82u/s`.
...
- Objective pressure: `pass`
  Evidence: fresh HUD samples showed solo bomb `11.8s to breach`, shared bomb `12.0s to breach`, solo hostage `1.4s to clear Water Tower Gate`, and shared hostage `1.6s to clear Water Tower Gate`.
